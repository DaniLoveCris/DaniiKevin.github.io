...
<html>
    ...
    <body>
		...
		<div id="home" style="text-align: center; top: 50%; -ms-transform: translateY(-1%); -webkit-transform: translateY(-1%); transform: translateY(-1%);">
				...
				<p><h2 style="color: black;"><big><big><big>Música Top 9</big></big></big></h2>
					...
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <strong><big style="text-align:center;">Adrian Rodriguez & Juan Magan - Love Me Again</strong></big>
	...
	?><a href="rec/Top/Adrian Rodriguez & Juan Magan - Love Me Again.mp3" download="Adrian Rodriguez & Juan Magan - Love Me Again">Descargar</a><?php } ?>
					...
					<strong><big style="text-align:center;">Afrojack & David Guetta - Another Life</strong></big>
				<audio controls controlsList="nodownload" width="263" height="56">
	...
	?><a href="rec/Afrojack & David Guetta - Another Life.mp3" download="Afrojack & David Guetta - Another Life">Descargar</a><?php } ?>
					...
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <strong><big style="text-align:center;">Bad Bunny, J.Balvin, Ozuna & Arcangel - Soy Peor Remix</strong></big>
				<audio controls controlsList="nodownload" width="263" height="56">
	...
	?><a href="rec/BAD BUNNY, J.BALVIN, OZUNA & ARCANGEL - SOY PEOR REMIX.mp3" download="Bad Bunny, J.Balvin, Ozuna & Arcangel - Soy Peor Remix">Descargar</a><?php } ?>
					...
					<strong><big style="text-align:center;">Cnco & Yande - Hey Dj</strong></big>
				<audio controls controlsList="nodownload" width="263" height="56"> 
	...
	?><a href="rec/CNCO & Yande - Hey Dj.mp3" download="Cnco & Yande - Hey Dj">Descargar</a><?php } ?>
					...
					<strong><big style="text-align:center;">David Guetta & Justin Bieber - 2U</strong></big>
				<audio controls controlsList="nodownload" width="263" height="56">
	...
	?><a href="rec/David Guetta & Justin Bieber - 2U.mp3" download="David Guetta & Justin Bieber - 2U">Descargar</a><?php } ?>
					...
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <strong><big style="text-align:center;">J.Balvin, Nicky Jam & Cosculluela - Ayer 2</strong></big>
				<audio controls controlsList="nodownload" width="263" height="56">
	...
	<form>
					...
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp   <strong><big style="text-align:center;">Luis Fonsi, Daddy Yankee & Justin Bieber - Despacito</strong></big>
				<audio controls controlsList="nodownload" width="263" height="56">
	...
	?><a href="rec/Luis Fonsi, Daddy Yankee & Justin Bieber - Despacito.mp3" download="Luis Fonsi, Daddy Yankee & Justin Bieber - Despacito">Descargar</a><?php } ?>
					...
					<strong><big style="text-align:center;">Ozuna & Wisin - Escápate Conmigo</strong></big>
				<audio controls controlsList="nodownload" width="263" height="56">
	...
	?><a href="rec/Ozuna & Wisin - Escápate Conmigo.mp3" download="Ozuna & Wisin - Escápate Conmigo">Descargar</a><?php } ?>
					...
					<strong><big style="text-align:center;">Taburete - Sirenas</strong></big>
				<audio controls controlsList="nodownload" width="263" height="56">
